...
[Live GitHub website](https://saroltah.github.io/yoga-project/)
...
5.  *Prettier* ruined the consistency of HTML format.
    ...
    -> In _settings > user > extensions > prettier_ I marked the *Prettier: Bracket Same Line* checkbox. It didn't work. So I disabled the extension in the end, and used *HTML Format* extention instead.
...
| Correct HTML file                                                                 | Copy the code to The _W3C HTML validator_ website.                                                                | There are no errors                                                                                | There are no errors |
