...
| The text input fields are required                                                | Trying to submit them empty one by one                                                                         | It doesn't let submit, it writes out note that the you have to fill it first                                  | It doesn't let submit, it writes out note that the you have to fill it first                                                               |
| The email input field is required                                                 | Trying to submit them empty, then without the @, then without anything before @, then without anything after @ | It doesn't let submit, it writes out note that you need to write email format, having text before and after @ | It doesn't let submit, it writes out note that you need to write email format, having text before and after @                              |
| The submit button is working, and the form attributes are correct                 | Click on submit                                                                                                | It shows the written data on code institute's form-dump page                                                  | It shows the written data on code institute's form-dump page                                                                               |
| The input name and value is added correctly                                       | Submit my data                                                                                                 | On code institute's form-dump page the Input name and Value table is correct                                  | On code institute's form-dump page the Input name and Value table is correct                                                               |
| The contact icons change color, and cursor turns to pointer when we hover on them | Point on a contact icon                                                                                        | It changes color to brown from black, the cursor turns to pointer                                             | It changes color to brown from black, the cursor turns to pointer                                                                          |
| The Facebook icon - link is correct and opens in new tab                          | Click on facebook icon                                                                                         | It opens Facebook page in new tab                                                                             | It opens Facebook page in new tab                                                                                                          |
| The Instagram icon - link is correct and opens in new tab                         | Click on Instagram icon                                                                                        | It opens Instagram page in new tab                                                                            | It opens Instagram page in new tab                                                                                                         |
| The Twitter icon - link is correct and opens in new tab                           | Click on Twitter icon                                                                                          | It opens Twitter page in new tab                                                                              | It opens Twitter page in new tab                                                                                                           |
| The Email icon - link is correct and opens in new tab                             | Click on Email icon                                                                                            | It opens my email server with the reciever's email address:info@relief.com                                    | It opens my email server with the reciever's email address:info@relief.com                                                                 |
| Responsive in all screen sizes                                                    | Open developer tools and check. Also use Am I responsive? site                                                 | It looks good and all the functions are working properly in all sizes                                         | It looks good and all the functions are working properly in all sizes.                                                                     |
