...
| The contact icons change color when we hover on them                       | Point on a contact icon                                                                                        | It changes color to brown from black                                                                          | It changes color to brown from black                                                                          |
